...
public class CadastroPFController {
     ...
     */
    @PostMapping
    public ResponseEntity<Response<CadastroPFDto>> cadastrar(@Valid @RequestBody CadastroPFDto dto, BindingResult result) throws NoSuchAlgorithmException {
        log.info("Cadastro PF {}", dto.toString());
